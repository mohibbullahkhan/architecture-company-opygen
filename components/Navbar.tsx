...
export function Navbar() {
  ...
  return (
    <>
      <nav className="absolute top-0 left-0 right-0 z-[60] h-[80px] md:h-[100px] flex items-start px-6 md:px-12">
        <div className="w-full max-w-[1920px] mx-auto flex justify-between items-center md:items-start h-full relative">
          
          {/* Logo */}
          <div className="flex-1 md:pt-[30px] pt-4">
            <Link href="/" className="text-white text-[18px] md:text-[20px] font-bold tracking-[0.15em] uppercase font-sans">
              DNOIN.INC
            </Link>
          </div>
          ...
          <div className="hidden lg:block absolute top-0 left-1/2 -translate-x-1/2 h-[76px]">
            <div className="relative w-[700px] h-full bg-white rounded-b-[40px] flex justify-center items-center pt-2">
              {/* Left inverted corner */}
              <div className="absolute top-0 -left-[40px] w-[40px] h-[40px] bg-transparent rounded-tr-[40px] shadow-[20px_-20px_0_20px_white]" />
              {/* Right inverted corner */}
              <div className="absolute top-0 -right-[40px] w-[40px] h-[40px] bg-transparent rounded-tl-[40px] shadow-[-20px_-20px_0_20px_white]" />
          ...
          {/* Mobile Menu Toggle */}
          <div className="lg:hidden flex-1 flex justify-end pt-4">
            <button 
